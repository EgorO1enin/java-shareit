...
public class ItemServiceImpl implements ItemService {
    ...
    public ItemResponesDto addItem(Long userId, ItemRequestDto itemRequestDto) {
        ...
        if (itemRequestDto.getRequestId() != null) {
            // Проверяем, что такой запрос существует
            if (!itemRequestRepository.existsById(itemRequestDto.getRequestId())) {
                throw new NotFoundException("Запрос с id " + itemRequestDto.getRequestId() + " не найден");
            }
